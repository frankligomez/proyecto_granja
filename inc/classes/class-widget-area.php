...
if ( ! class_exists( 'Epagreenlite_Widget_Area' ) ) {

	class Epagreenlite_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'epagreenlite-theme/widget-area/render', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'epagreenlite-theme/widget_area/rendering_current', $area_id );
			...
			$classes = apply_filters( 'epagreenlite-theme/widget_area/classes', $classes, $area_id );
	...
	function epagreenlite_widget_area() {
		return Epagreenlite_Widget_Area::get_instance();
	}

	epagreenlite_widget_area();
}
