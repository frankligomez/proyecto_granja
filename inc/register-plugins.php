 ...
 */
add_action( 'tgmpa_register', 'epagreenlite_register_required_plugins' );
/**
 ...
 */
function epagreenlite_register_required_plugins() {
	/*
	...
	$plugins = array(
		array(
			'name'   => esc_html__( 'Jet Plugins Wizard', 'epagreenlite' ),
