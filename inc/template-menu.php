 ...
 * @return void
 */
function epagreenlite_main_menu() {
	...
	<nav id="site-navigation" class="<?php echo join( ' ', $classes ); ?>" role="navigation">
		...
		<?php
			$args = apply_filters( 'epagreenlite-theme/menu/main-menu-args', array(
				'theme_location'   => 'main',
				'container'        => '',
				'menu_id'          => 'main-menu',
				'fallback_cb'      => 'epagreenlite_set_nav_menu',
				'fallback_message' => esc_html__( 'Set main menu', 'epagreenlite' ),
			) );
 ...
 * @return void
 */
function epagreenlite_footer_menu() { ?>
	<nav id="footer-navigation" class="footer-menu" role="navigation">
	<?php
		$args = apply_filters( 'epagreenlite-theme/menu/footer-menu-args', array(
			...
			'fallback_message' => esc_html__( 'Set footer menu', 'epagreenlite' ),
		) );
 ...
 * @return string
 */
function epagreenlite_get_social_list( $context, $type = 'icon' ) {
	static $instance = 0;
	$instance++;
	...
	$args = apply_filters( 'epagreenlite-theme/social/list-args', array(
		...
		'echo'             => false,
		'fallback_cb'      => 'epagreenlite_set_nav_menu',
		'fallback_message' => esc_html__( 'Set social menu', 'epagreenlite' ),
	), $context, $type );
 ...
 * @return void
 */
function epagreenlite_set_nav_menu( $args ) {
